...
$sql = "select registrations.*, courses.name as course_title, courses.price as courses_price from registrations inner join courses on
...
<table border="1" cellpadding="10" cellspacing="0">
    ...
    while($result = mysqli_fetch_array($query)) :
        $total_price = $result['courses_price'] * $result['participant_count'];
    ?>
        <tr>
            <td><?= $no++ ?></td>
            ...
            <td>
                ...
                <?php else : ?>
                    <a href="cancel_follow_up.php?id=<?= $result['id']; ?>"
                        onclick="return confirm('Cancel the follow up status?')">
                            Cancel follow Up
                    </a>
                <?php endif; ?>
            </td>
